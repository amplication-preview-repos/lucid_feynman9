...
const CREATE_INPUT = {
  amount: 42.424242424,
  counterpartyName: "exampleCounterpartyName",
  createdAt: new Date(),
  ...
  dueDate: new Date(),
  externalRef: "exampleExternalRef",
  id: "exampleId",
  isRecurring: "true",
  paidAt: new Date(),
  recurrenceRule: "exampleRecurrenceRule",
  title: "exampleTitle",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  ...
  test("POST /transactions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateOccurred: CREATE_RESULT.dateOccurred.toISOString(),
      ...
      .expect([
        {
          ...
          dateOccurred: FIND_MANY_RESULT[0].dateOccurred.toISOString(),
  ...
  test("GET /transactions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateOccurred: FIND_ONE_RESULT.dateOccurred.toISOString(),
