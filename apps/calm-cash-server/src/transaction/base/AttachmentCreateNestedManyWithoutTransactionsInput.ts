...
@InputType()
class AttachmentCreateNestedManyWithoutTransactionsInput {
...
export { AttachmentCreateNestedManyWithoutTransactionsInput as AttachmentCreateNestedManyWithoutTransactionsInput };
