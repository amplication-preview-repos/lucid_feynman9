...
@InputType()
class InvitationCreateNestedManyWithoutAccountsInput {
...
export { InvitationCreateNestedManyWithoutAccountsInput as InvitationCreateNestedManyWithoutAccountsInput };
